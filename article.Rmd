...
dfCronbachsAlpha <- data.frame(module, num_items, num_responses, alpha)

(dfCronbachsAlpha)
```
Ideally we're looking for alphas of 0.7 and above; less than this indicates that there is weak covariance between the items in the module, which means they may not be testing the same ability.
