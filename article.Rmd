...
#### Module A Mapping Function, $g_{A}()$
...
$$
s(\hat{\theta}_i) = k\frac{\hat{\theta}_i - min(\theta)}{max(\theta) - min(\theta)}
$$
...
scaleScore <- s(thetaEstimate = -0.5, thetaRange = c(-4, 4))
